        ...
        <div class="col-lg-4 col-md-4 text-center">
            <div class="center-block">
                <p class="lead text-justify">
                    Create a new alert. This will be displayed to all teams for the next 1 minute.
                </p>
            </div>
        </div>
            ...
            <form class="form-horizontal create">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="alert_text">Alert Text</label>

                        <div class="col-md-5">
                            <input id="alert_text" name="alert_text" placeholder="Alert Text"
...
<script>
    ...
    $(".create").submit(function (e) {
        ...
        $.post("../../assets/api.php", {type: "create_alert", alert_text: alert}, function (e) {
            console.log(e);
            $(".alert-info").hide();
            if (e.error) {
