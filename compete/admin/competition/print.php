...
$state = $db->prepare("select pd.* from problem_data pd inner join competition_section_problems csp on csp.problem_id = pd.id where csp.section_id = ? and csp.removed = 0");
