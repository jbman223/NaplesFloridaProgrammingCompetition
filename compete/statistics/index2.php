            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 hidden-sm hidden-xs text-center">
                        ...
                        <a href="#" target="_blank" class="btn btn-default btn-block"><span
                                class="glyphicon glyphicon-download"></span> Press Release</a>
                        <a href="#" target="_blank" class="btn btn-success btn-block"><span
                                class="glyphicon glyphicon-user"></span> Result Sheet</a>
                        <a href="#" target="_blank" class="btn btn-info btn-block"><span
                                class="glyphicon glyphicon-picture"></span> Photo Album</a>
                        <a href="#" target="_blank" class="btn btn-danger btn-block"><span
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <? if (isUserLoggedIn()) {
                                                ...
                                                ?>
                                                <a href="../account/login.php" class="btn btn-sm btn-default">Log in to
